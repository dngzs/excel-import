package com.best.excel.imports.xls;
...
public class ExcelXlsReader implements HSSFListener{
    ...
    public ExcelXlsReader(ISaxRowRead read, InputStream inputstream, boolean outputFormulaValues) throws Exception {
        this.read = read;
    ...
    public void processRecord(Record record) {
        ...
        switch (record.getSid()) {
            ...
            case BlankRecord.sid: //单元格为空白
                ...
                thisStr = "";
                rowList.add(thisColumn, new SaxReadCellEntity(CellValueType.String, thisStr));
                break;
            case BoolErrRecord.sid: //单元格为布尔类型
                ...
                rowList.add(thisColumn, new SaxReadCellEntity(CellValueType.Boolean, thisStr));
            ...
            case LabelRecord.sid:
                ...
                rowList.add(thisColumn, new SaxReadCellEntity(CellValueType.Boolean, value));
            ...
            case LabelSSTRecord.sid: //单元格为字符串类型
                ...
                if (sstRecord == null) {
                    rowList.add(thisColumn, new SaxReadCellEntity(CellValueType.String, ""));
                } else {
            ...
            case NumberRecord.sid: //单元格为数字类型
                ...
                value = value.equals("") ? "" : value;
                //向容器加入列值
                rowList.add(thisColumn, new SaxReadCellEntity(CellValueType.Number, value));
                //如果里面某个单元格含有值，则标识该行不为空行
                checkRowIsNull(value);
                break;
            default:
